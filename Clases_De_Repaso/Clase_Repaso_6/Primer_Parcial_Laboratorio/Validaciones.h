 ...
 *
 * \param mensajeInicial[] char El mensaje preguntando por una confirmacion dando a elejir con ("s" o "n")
 * \param mensajeVolverAConfirmar[] char El mensaje aclarando que solo se confirma con ("s" o "n")
 * \return int Si ingreso "s" [1] si ingreso "n" [0] en caso de error [-1]
 *
 */
int confirmarCambios(char mensajeInicial[],char mensajeVolverAConfirmar[]);

/** \brief Valida si el usuario ingreso: ("f" o "m")
 *
 * \param mensajeInicial[] char El mensaje preguntando por el sexo de una persona ("f" o "m")
 * \param mensajeVolverAConfirmar[] char El mensaje aclarando que solo se confirma con ("f" o "m")
 * \return int Si ingreso "f" [1] si ingreso "m" [0] en caso de error [-1]
 *
 */
int validarSoloSexo(char mensajeInicial[],char mensajeVolverAConfirmar[]);
