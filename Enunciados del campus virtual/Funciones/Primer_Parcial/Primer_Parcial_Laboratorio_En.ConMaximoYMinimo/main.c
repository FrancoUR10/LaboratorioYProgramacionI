...
int main()
{
    ...
    eAuxPelicula listaAuxPeliculas[MAX_PELICULA];
    ...
    do
    {
        ...
        {
            case 1:
                actor_gestionarActores(listaActores,MAX_ACTOR,listaPaises,MAX_PAIS,&contAltasActores);
                break;
            case 2:
                elenco_gestionarElencos(listaElencos,MAX_ACTOR*MAX_PELICULA,listaActores,MAX_ACTOR,listaPeliculas,MAX_PELICULA,listaGeneros,MAX_GENERO,listaPaises,MAX_PAIS,&contAltasElencos);
                break;
            case 3:
                elenco_informarDatos(listaElencos,MAX_ACTOR*MAX_PELICULA,listaActores,MAX_ACTOR,listaPeliculas,MAX_PELICULA,listaGeneros,MAX_GENERO,listaPaises,MAX_PAIS,listaAuxPeliculas);
                break;
            case 4:
                continuarMenu='n';
                break;
