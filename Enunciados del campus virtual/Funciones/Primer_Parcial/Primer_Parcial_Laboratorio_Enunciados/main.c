    ...
    do
    {
        ...
        switch(opcionMenu)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                elenco_informarDatos(listaElencos,MAX_ACTOR*MAX_PELICULA,listaActores,MAX_ACTOR,listaPeliculas,MAX_PELICULA,listaGeneros,MAX_GENERO,listaPaises,MAX_PAIS);
                break;
            case 4:
                continuarMenu='n';
                break;
