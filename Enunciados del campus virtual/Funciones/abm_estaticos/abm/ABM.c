...
{
    printf("\n%d\t",unEmpleado.id);
    printf("%10s",unEmpleado.nombre);
    printf("%16s",unEmpleado.apellido);
    printf("%17s",unEmpleado.genero);
...
void empleado_mostrarLista(eEmpleado listaEmpleado[],int tamEmpleado)
{
    ...
    else
    {
        ...
        printf("\nID          NOMBRE        APELLIDO       GENERO         EDAD    SUELDO\n");
        for(i=0;i<tamEmpleado;i++)
        {
            if(listaEmpleado[i].estado==OCUPADO)
            {
                empleado_mostrarUnoSolo(listaEmpleado[i]);
            }
        }
    }
}
...
int empleado_darDeBaja(eEmpleado listaEmpleado[],int tamEmpleado)
{
    ...
    {
        empleado_mostrarLista(listaEmpleado,tamEmpleado);
...
int empleado_modificarDatos(eEmpleado listaEmpleado[],int tamEmpleado)
{
    ...
    else
    {
        ...
        if(getStrNumerosSinRango("\nIngrese el id a modificar: ",auxIdStr,"\nSolo se permiten numeros\n",3))
        {
            ...
            {
                empleado_pedirDatosAModificar(listaEmpleado,indiceBusqueda);
                sePudo=1;
            }
        }
    }
...
void empleado_pedirDatosAModificar(eEmpleado listaEmpleado[],int indice)
{
    ...
    do
    {
        ...
        empleado_mostrarUnoSolo(listaEmpleado[indice]);
        printf("\nDatos a modificar:\n");
        empleado_mostrarUnoSolo(proximosDatos);
