...
int main()
{
    ...
    LinkedList* listaLocalidades=ll_newLinkedList();
    ...
    do
    {
        ...
        switch(opcionMenu)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                empleado_darDeAlta(listaEmpleados,listaLocalidades,&contAltas);
                break;
            case 4:
                empleado_darDeBaja(listaEmpleados,listaLocalidades);
                break;
            case 5:
                empleado_modificarDatos(listaEmpleados,listaLocalidades);
                break;
            case 6:
                empleado_ordenarEmpleados(listaEmpleados);
                break;
            case 7:
                empleado_mostrarListaEmpleados(listaEmpleados,listaLocalidades);
                break;
            case 8:
