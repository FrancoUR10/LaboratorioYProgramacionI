...
/** \brief Setea la localidad de un empleado
 *
 * \param empleado eEmpleado* El puntero a un empleado
 * \param idLocalidad int El id de la localidad
 * \return int Si seteo la localidad [1] si no [0]
 *
 */
...
/** \brief Obtiene la localidad de un empleado por parametros
 *
 * \param empleado eEmpleado* El puntero a un empleado
 * \param idLocalidad int* El id de la localidad a obtener
 * \return int Si se obtuvo la localidad [1] si no [0]
 *
 */
